      ...
      <div class="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div class="mt-6 grid gap-3 sm:mt-8 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
          @for (type of documentTypes(); track type.slug) {
            ...
            >
              <span
                class="inline-flex h-12 w-12 items-center justify-center rounded-lg border border-primary-200 bg-primary-50 text-primary-700 shadow-sm transition-colors group-hover:border-primary-300 group-hover:bg-primary-100 group-hover:text-primary-800 sm:h-14 sm:w-14"
              >
