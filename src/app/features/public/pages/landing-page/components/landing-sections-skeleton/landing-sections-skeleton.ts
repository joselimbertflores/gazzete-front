...
<section class="border-b border-surface-200 bg-surface-100/80" aria-labelledby="recent-skeleton-title">
  <div class="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
      <div>
...
<section class="bg-surface-0" aria-labelledby="stats-skeleton-title">
  <div class="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
    <div class="max-w-2xl">
