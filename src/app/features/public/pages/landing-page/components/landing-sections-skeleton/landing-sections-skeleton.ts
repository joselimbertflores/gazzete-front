    ...
    >
      <div class="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-18 lg:px-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div class="max-w-2xl">
            <h2
              id="featured-skeleton-title"
              class="text-2xl font-semibold text-surface-0 sm:text-3xl"
            >
        ...
        <div class="-mx-4 mt-6 flex gap-4 overflow-hidden px-4 py-6 sm:-mx-6 sm:mt-8 sm:px-6">
          @for (item of featuredSkeletonItems; track item) {
            <article
              class="min-h-80 w-[calc(100%-1rem)] flex-none overflow-hidden rounded-lg border border-surface-200 bg-surface-0 shadow-xl shadow-primary-950/20 sm:min-h-88 sm:w-[82%] lg:w-[70%]"
            >
              ...
              <div class="p-6 sm:p-8 lg:p-9">
                ...
                <div
                  class="mt-8 flex items-center justify-between border-t border-surface-200 pt-5"
                >
