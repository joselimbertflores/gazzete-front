...
@Component({
  ...
  template: `
    <section
      class="public-motion-safe flex min-h-[42vh] items-center bg-linear-to-b from-surface-0 to-primary-50/35 motion-safe:animate-enter motion-safe:fade-in-0 motion-safe:slide-in-from-b-6 motion-safe:animate-duration-500 motion-safe:animate-ease-out motion-safe:animate-fill-both"
      aria-live="polite"
    >
